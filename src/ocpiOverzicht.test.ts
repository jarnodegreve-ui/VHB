...
describe('bouwDagen / bouwTotalen', () => {
  ...
  // Controle-ronde 09-09, nr. 1: de historiek laadt sessies zonder
  // charging_periods, dus laadMin is daar van elke sessie null. Dat mag geen
  // 0 worden — dan staat er een fout getal in de tabel en de Excel-export.
