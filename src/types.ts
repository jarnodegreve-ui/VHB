...
export type View = 'dashboard' | 'mijn-dag' | 'omleidingen' | 'rooster' | 'updates' | 'beheer-roosters' | 'beheer-updates' | 'gebruikers' | 'toestellen' | 'beheer-omleidingen' | 'contacten' | 'dienstoverzicht' | 'beheer-dienstoverzicht' | 'ruil-verzoeken' | 'verlof-kalender' | 'verlof' | 'planning-matrix' | 'planning-codes' | 'activiteit' | 'beheer-debug' | 'ritblaadjes' | 'documenten' | 'bezetting' | 'dekking' | 'assistent' | 'ocpi-monitoring' | 'vervaldata' | 'ziekte' | 'instellingen' | 'designsysteem' | 'meldingen' | 'roostersolver';
