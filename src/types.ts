...
// dezelfde regels gebruiken. Her-export zodat bestaande imports blijven werken.
export { isRijdend, isFlexi, teltInVerlofbezetting } from '../shared/verlofbezetting';
...
export type View = 'dashboard' | 'mijn-dag' | 'omleidingen' | 'rooster' | 'updates' | 'beheer-roosters' | 'beheer-updates' | 'gebruikers' | 'toestellen' | 'beheer-omleidingen' | 'contacten' | 'dienstoverzicht' | 'ruil-verzoeken' | 'verlof-kalender' | 'verlof' | 'planning-matrix' | 'planning-codes' | 'activiteit' | 'beheer-debug' | 'ritblaadjes' | 'documenten' | 'bezetting' | 'dekking' | 'ocpi-monitoring' | 'vervaldata' | 'ziekte' | 'instellingen' | 'designsysteem' | 'meldingen' | 'defecten' | 'werkprestaties' | 'voertuig-werken' | 'voertuigen' | 'dagafsluiting' | 'looncontrole' | 'dienstopbouw' | 'werkvoorraad' | 'vandaag' | 'rapporten';
