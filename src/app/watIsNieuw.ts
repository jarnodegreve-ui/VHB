...
export const WAT_IS_NIEUW: WatIsNieuwItem[] = [
  ...
  {
    id: '2026-09-14',
    titel: 'Dagadministratie en looncontrole',
    regels: {
      staf: [
        'Beheer › Dagadministratie: open een dag (de planning van die dag wordt gekopieerd, met ruilen en verlof), pas aan wie werkelijk wat reed, vul overminuten, premie en kwaliteitsvlaggen in en sluit de dag af. Dit vervangt het dagelijks intikken in Access.',
