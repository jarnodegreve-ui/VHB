...
export function BrandBus({
  ...
  const body = dark ? 'var(--color-slate-100, #F2F3F4)' : 'var(--color-slate-900, #0D0D0F)';      // bus-lichaam + wielrand (VHB Black / Light Grey)
  const wheelHub = dark ? 'var(--color-slate-900, #0D0D0F)' : '#FFFFFF';   // wiel-hart (contrast met rand)
  return (
    <svg
    ...
    >
      <g transform="translate(310 60) scale(0.66) translate(-505 -192)">
        ...
        <rect x="234" y="228" width="96" height="24" rx="12" fill="var(--color-oker-500, #E8A33D)" />
        <rect x="198" y="276" width="132" height="24" rx="12" fill="var(--color-oker-500, #E8A33D)" />
        <rect x="234" y="324" width="96" height="24" rx="12" fill="var(--color-oker-500, #E8A33D)" />
        {/* Bus-lichaam */}
        <rect x="354" y="192" width="360" height="192" rx="33.6" fill={body} />
        {/* Drie oker raampjes */}
        <rect x="392.4" y="228" width="81.6" height="62.4" rx="12" fill="var(--color-oker-500, #E8A33D)" />
        <rect x="493.2" y="228" width="81.6" height="62.4" rx="12" fill="var(--color-oker-500, #E8A33D)" />
        <rect x="594" y="228" width="81.6" height="62.4" rx="12" fill="var(--color-oker-500, #E8A33D)" />
