    ...
    <AnimatePresence>
      {visible && deferred && (
        <motion.div
          ...
          className="fixed inset-x-0 z-toast flex justify-center px-4 pointer-events-none bottom-[calc(max(0.75rem,env(safe-area-inset-bottom))+4.75rem)] md:bottom-[max(1rem,env(safe-area-inset-bottom))]"
        >
