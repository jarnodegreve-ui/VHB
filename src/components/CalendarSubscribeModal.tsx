  ...
  return (
    <Modal open={open} onClose={onClose} maxWidth="md">
      <div className="p-6">
        ...
        {/* Abonneren */}
        <div className="mt-5">
          <div className="text-[10px] font-black uppercase tracking-widest text-slate-400">Abonneren (blijft up-to-date)</div>
        ...
        <div className="mt-5 pt-4 border-t border-slate-100">
          <div className="text-[10px] font-black uppercase tracking-widest text-slate-400">Of eenmalig</div>
          <button
            type="button"
