            ...
            <>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between gap-3">
                  <h4 className="text-[11px] font-black uppercase tracking-widest text-slate-500">Dag-types &amp; verwachte diensten</h4>
                  <button type="button" onClick={addDayType} className="ios-pressable inline-flex items-center gap-1.5 px-3 h-9 rounded-xl border border-slate-200 bg-white text-[10px] font-black uppercase tracking-widest text-slate-600 hover:bg-slate-50 transition-colors">
                      ...
                      return (
                        <div key={i} className="rounded-2xl border border-slate-100 bg-white/60 p-4">
                          <div className="flex items-center gap-2">
                            ...
                            />
                            <span className="shrink-0 text-[10px] font-black uppercase tracking-widest text-slate-400 tabular-nums">{dt.services.length} {dt.services.length === 1 ? 'dienst' : 'diensten'}</span>
              ...
              <div className="border-t border-slate-100 pt-5 space-y-3">
                <div>
                  <h4 className="text-[11px] font-black uppercase tracking-widest text-slate-500">Standaard per weekdag</h4>
              ...
              <div className="border-t border-slate-100 pt-5 space-y-3">
                <div className="flex items-start justify-between gap-3">
                  <div>
                    <h4 className="text-[11px] font-black uppercase tracking-widest text-slate-500">Uitzonderingen</h4>
                  ...
                  <button type="button" onClick={addOverride} className="ios-pressable shrink-0 inline-flex items-center gap-1.5 px-3 h-9 rounded-xl border border-slate-200 bg-white text-[10px] font-black uppercase tracking-widest text-slate-600 hover:bg-slate-50 transition-colors">
