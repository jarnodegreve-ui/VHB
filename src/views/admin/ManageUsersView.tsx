          ...
          <>
            ...
            <form onSubmit={handleUpdateUser} className="p-6 md:p-7 space-y-4">
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <Field label="In dienst sinds" htmlFor="bewerk-startdatum" error={bewerkFouten.startDate} hint="Bepaalt de anciënniteit-volgorde binnen een sectie in de Maandplanning."><Input id="bewerk-startdatum" type="date" value={editingUser.startDate || ''} onChange={(e) => setEditingUser({ ...editingUser, startDate: e.target.value || undefined })} /></Field>
