  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
        ...
        <OpsStat icon={<Gauge size={16} />} tone="slate" label="Vandaag geladen" text={fmtKwh(grafiek.dagen.at(-1)?.kwh ?? 0)} suffix={' kWh'} sub={`30 d: ${tekstKwh(kwh30)} · ${data.totals.sessions30d} sessies`} onClick={() => onDag(vandaag)} />
      </div>
