...
import { parsePlanningMatrixXlsx } from '../api/helpers';
...
describe('parsePlanningMatrixXlsx', () => {
  it('parseert een geldige praktijk-tab naar matrix-rijen', () => {
    ...
    const rows = parsePlanningMatrixXlsx(buffer);
  ...
  it('weigert een werkboek zonder praktijk-tab met een duidelijke fout', () => {
    ...
    expect(() => parsePlanningMatrixXlsx(buffer)).toThrow(/praktijk/i);
  });
  ...
  it('weigert een tab zonder aantal-kolom', () => {
    ...
    expect(() => parsePlanningMatrixXlsx(buffer)).toThrow(/aantal/i);
  });
  ...
  it('weigert dubbele datumrijen (laatste-wint zou data stil laten verdwijnen)', () => {
    ...
    expect(() => parsePlanningMatrixXlsx(buffer)).toThrow(/dubbele datumrijen/i);
  });
  ...
  it('weigert dubbele chauffeur-kolommen', () => {
    ...
    expect(() => parsePlanningMatrixXlsx(buffer)).toThrow(/dubbele chauffeur-kolommen/i);
  });
