...
73. `supabase/2026-09-25_mail_log.sql`, verzendlog van de portaalmails: tabel `mail_log` (soort, moment, aantal, gelukt, fout, door; bewust zonder inhoud of adressen), RLS aan zonder policies, grants voor anon/authenticated ingetrokken. Raakt RLS en grants: daarna `beleid-drift.mjs --update` en de snapshot committen.
