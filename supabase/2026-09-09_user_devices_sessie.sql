...
-- De gate vraagt bij elk verzoek "hoort deze sessie bij een ingetrokken
-- toestel?". Partieel: alleen ingetrokken rijen met een sessie zijn relevant,
-- dus de index blijft klein.
