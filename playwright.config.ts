...
const DESKTOP_SPECS = /(desktop|a11y|omleidingen-layout|ziekte-overzicht|ritblad-zoom|rapporten|beheer-tabellen|techniek-loon-tabellen|planning-tabellen)\.spec\.ts$/;
  ...
  projects: [
    {
      ...
      testMatch: /(mobiele-navigatie|dock-transitie|activiteit-layout|beheer-dienstoverzicht-layout|omleidingen-layout|ziekte-overzicht|ritblad-zoom|rapporten|warmup-verlaten)\.spec\.ts$/,
