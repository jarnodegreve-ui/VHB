...
const DESKTOP_SPECS = /(desktop|a11y|omleidingen-layout|ziekte-overzicht|ritblad-zoom|rapporten|beheer-tabellen|techniek-loon-tabellen|planning-tabellen|deeplinks[\w-]*|datumveld[\w-]*|dagadministratie-grens|\/dienstoverzicht[\w-]*|scroll-lock)\.spec\.ts$/;
  ...
  projects: [
    {
      ...
      testMatch: /(mobiele-navigatie|scroll-lock|dock-transitie|activiteit-layout|beheer-dienstoverzicht-layout|dienstoverzicht-beheer|omleidingen-layout|ziekte-overzicht|ritblad-zoom|rapporten|warmup-verlaten|deeplinks[\w-]*|datumveld[\w-]*|dagadministratie-grens)\.spec\.ts$/,
