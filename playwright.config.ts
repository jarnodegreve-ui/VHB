  ...
  projects: [
    {
      ...
      testMatch: /(mobiele-navigatie|dock-transitie|activiteit-layout|beheer-dienstoverzicht-layout|omleidingen-layout|ziekte-overzicht|ritblad-zoom|rapporten)\.spec\.ts$/,
