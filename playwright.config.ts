...
const DESKTOP_SPECS = /(desktop|a11y|omleidingen-layout|ziekte-overzicht|ritblad-zoom|rapporten|beheer-tabellen|techniek-loon-tabellen|planning-tabellen|deeplinks[\w-]*|datumveld[\w-]*|dagadministratie-grens|\/dienstoverzicht[\w-]*|scroll-lock|lagen|panelen|laadfouten|rooster-gereden|beheer-mails|omleiding-mailen)\.spec\.ts$/;
