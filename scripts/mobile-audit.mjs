...
const ADMIN_VIEWS = ['dashboard', 'mijn-dag', 'werkvoorraad', 'verlof', 'verlof-kalender', 'ziekte', 'dekking', 'beheer-roosters', 'planning-matrix', 'planning-codes', 'dienstoverzicht', 'beheer-dienstoverzicht', 'dienstopbouw', 'dagafsluiting', 'looncontrole', 'beheer-updates', 'beheer-omleidingen', 'meldingen', 'defecten', 'werkprestaties', 'voertuigen', 'vervaldata', 'gebruikers', 'toestellen', 'activiteit', 'beheer-debug', 'designsysteem', 'ocpi-monitoring', 'instellingen'];
