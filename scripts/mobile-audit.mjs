...
// Alle views uit src/app/routes.tsx per rol (golf 4: aangevuld met meldingen,
...
const ADMIN_VIEWS = ['dashboard', 'mijn-dag', 'werkvoorraad', 'verlof', 'verlof-kalender', 'ziekte', 'dekking', 'beheer-roosters', 'planning-matrix', 'planning-codes', 'dienstoverzicht', 'beheer-dienstoverzicht', 'dienstopbouw', 'dagafsluiting', 'looncontrole', 'beheer-updates', 'beheer-omleidingen', 'meldingen', 'defecten', 'werkprestaties', 'voertuig-werken', 'voertuigen', 'vervaldata', 'gebruikers', 'toestellen', 'activiteit', 'beheer-debug', 'designsysteem', 'ocpi-monitoring', 'instellingen'];
