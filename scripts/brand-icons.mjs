...
//   vhb-favicon.svg / -64.png / favicon.ico tab-icoon, beeldmerk iets groter
...
/** Carbon tegel (1024²) met het beeldmerk gecentreerd op `markWidth` px breed. */
...
const FAVICON = tileSvg({ rx: 200, markWidth: 880, title: 'VHB' });
