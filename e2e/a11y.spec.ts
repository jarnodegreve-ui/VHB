...
const SCHERMEN: Scherm[] = [
  ...
  { naam: 'chauffeur-rooster', user: CHAUFFEUR, view: 'rooster', klaar: async (page) => { await expect(page.getByRole('heading', { name: 'Rooster', level: 1 })).toBeVisible({ timeout: 15_000 }); } },
