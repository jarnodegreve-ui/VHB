 ...
 *
 * Gedeeld tussen client (laadpalenpagina) en server (Excel-export), daarom
 * in shared/ (08-09-2026). Wijzigt er een plaats op het plein, pas dan
 * alléén deze tabel aan.
 */
